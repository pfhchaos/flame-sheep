...
def _make_overlay_class():
    """Create the WindowConfig subclass lazily.

    moderngl-window must not be imported until after we set
    settings.WINDOW['class'] to force GLFW on Wayland.
    """
